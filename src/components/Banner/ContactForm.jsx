...
const ContactForm = () => {
  ...
  return (
    <div
      className="flex flex-col lg:flex-row w-full py-8 px-6 lg:px-24 bg-stone-950"
      id="contact"
    >
      {/* Text Column */}
      <Toaster />
      ...
      >
        <h1 className="text-2xl lg:text-4xl font-bold text-gray-200 mb-4">
          Get In Touch
        </h1>
        <p className="text-gray-400 mb-6">
          If you have any issues or inquiries, send us a message. We’ll get back
